...
SRC_URI += "file://Robopeak-Kconfig-patch.patch"
SRC_URI += "file://robopeak_driver_makefile.patch"

#do_kernel_configme_prepend() {
do_patch_prepend() {
  if [ ! -d ${S}/drivers/video/robopeak ]; then
      mkdir -p ${S}/drivers/video/robopeak
  fi 
  #bzip2 -dc .tar.bz2 | (cd ${S}/linux;tar xf -)
  cp -rf ${S}/../robopeak ${S}/drivers/video
}

#addtask compile_prepend before do_compile
#EXPORT_FUNCTIONS do_compile_prepend
